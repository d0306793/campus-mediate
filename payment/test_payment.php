...
<body>
    <div class="payment-container">
        <div class="payment-header">
            ...
            <p><a href="#" onclick="history.back()"><i class="fas fa-arrow-left"></i> Back to Booking</a></p>
        </div>
        ...
        <form method="POST">
            <div class="payment-methods">
                ...
                <?php if (empty($payment_methods)): ?>
                    <div class="alert alert-warning">No payment methods available for this hostel.</div>
                <?php else: ?>
